...
export default function Search() {
    ...
    useEffect(() => {
        ...
        const searchedTermFromUrl = urlParams.get('searchedTerm');
        ...
        if(
            ...
            setSidebardata({
                searchTerm: searchedTermFromUrl || '',
    ...
    return (
        <div className='flex flex-col md:flex-row'>
            ...
            <div className="flex-1">
                <h1 className='text-3xl font-semibold border-b p-3 text-slate-700 mt-5 md:min-w-full'>Listing results:</h1>
                <div className="p-7 flex flex-wrap gap-4">
                    ...
                    {showMore && (
                        <button
                            ...
                            className='text-green-700 hover:underline p-7 border border-green-700 rounded-lg'
                        >Show more</button>
                    )}
                </div>
            </div>
